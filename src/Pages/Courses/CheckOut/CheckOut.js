...
const CheckOut = () => {
	...
	<div className="container mx-auto p-4 sm:p-10">
		<div className="mb-16 space-y-4 text-center">
			...
			<p className="px-4 sm:px-8 lg:px-24">Ours services are the best in Bangladesh</p>
			<div>
			...
			<div className="relative z-0 flex flex-col items-center p-8 border rounded-md">
				...
				<ul className="flex-1 space-y-2">
					...
					<li className="flex items-center space-x-2">
						...
						<span>3 hours tutorial</span>
					</li>
				</ul>
				<button className="px-4 py-2 mt-4 font-semibold uppercase border rounded-lg md:mt-12 sm:py-3 sm:px-8 dark:border-violet-400">Add to Cart</button>
			</div>
			<div className="relative flex flex-col items-center p-8 border-2 rounded-md dark:border-violet-400 dark:bg-gray-800">
				...
				<ul className="flex-1 space-y-2">
					...
					<li className="flex items-center space-x-2">
						...
						<span>3 professional mentor</span>
					</li>
					<li className="flex items-center space-x-2">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 dark:text-violet-400">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
				...
				<button className="px-8 py-3 mt-12 text-lg font-semibold uppercase rounded dark:bg-violet-400 dark:text-gray-900">Add to Cart</button>
			</div>
			<div className="relative z-0 flex flex-col items-center p-8 border rounded-md dark:bg-gray-800">
				...
				<ul className="flex-1 space-y-2">
					...
					<li className="flex items-center space-x-2">
						...
						<span>life time videos access</span>
					</li>
					<li className="flex items-center space-x-2">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 dark:text-violet-400">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
					...
					<li className="flex items-center space-x-2">
						...
						<span>exam per week</span>
					</li>
				</ul>
				<button className="px-8 py-3 mt-12 text-lg font-semibold uppercase border rounded dark:border-violet-400">Add to Cart</button>
			</div>
		</div>
	</div>
</section>
